    ...
    return (
        <div className="flex flex-col p-4 bg-blue-200 gap-4">
          ...
          <div className=" flex bg-white px-2 py-1 gap-2">
              ...
              {isLoggedIn ?(<button className="bg-blue-600 text-white h-full p-2 font-bold hover:bg-blue-200 text-xl">
                Book Now
              </button>):
              (<button className="bg-blue-600 text-white h-full p-2 font-bold hover:bg-blue-200 text-xl"
              >
                Sign in to Book
              </button>)}
            </div>
