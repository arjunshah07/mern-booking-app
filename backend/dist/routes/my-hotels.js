...
router.post("/", auth_1.default, [
    ...
    (0, express_validator_1.body)("nfacilities").notEmpty().isArray().withMessage('Facilities are required'),
...
function uploadImages(imageFiles) {
    return __awaiter(this, void 0, void 0, function* () {
        const uploadPromise = imageFiles.map((image) => __awaiter(this, void 0, void 0, function* () {
        ...
        const imageUrls = yield Promise.all(uploadPromise);
        return imageUrls;
    });
}
